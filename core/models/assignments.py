...
class Assignment(db.Model):
    ...
    def grade_assignment(cls, _id, teacher_id, grade):
       assignment = Assignment.get_by_id(_id) 
       assertions.assert_found(assignment, 'No assignment with this id was found')
       assertions.assert_valid(assignment.teacher_id == teacher_id, 'This assignment belongs to some other teacher')
       assertions.assert_valid(assignment.state == AssignmentStateEnum.SUBMITTED, 'This assignment belongs to some other teacher')
